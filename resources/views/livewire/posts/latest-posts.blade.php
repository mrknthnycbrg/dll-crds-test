<div class="relative" data-hs-carousel='{"loadingClasses": "opacity-0","isAutoPlay": true}'>
            ...
            @forelse ($latestPosts as $latestPost)
                <a class="hs-carousel-slide group" href="{{ route('show-post', ['slug' => $latestPost->slug]) }}"
                    ...
                    <div class="flex h-full flex-col justify-end"
                        ...
                        <div
                            class="space-y-2 bg-blue-800 bg-opacity-50 px-4 py-8 text-left backdrop-blur-md sm:px-6 lg:px-8">
    ...
    @if ($latestPosts->count() > 1)
        ...
        <button
            class="hs-carousel-next hs-carousel:disabled:opacity-50 absolute inset-y-0 end-0 inline-flex h-full w-[46px] items-center justify-center text-gray-900 hover:bg-gray-900/[.1] disabled:pointer-events-none"
            type="button">
            <span class="sr-only">
                Next
            </span>
